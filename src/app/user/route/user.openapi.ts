...
const createUserRequestSchema = z
  .object({
    email: z.string().email().openapi({
      example: "staff@diseminasi.com",
    }),
    password: z.string().min(1).openapi({
      example: "staff123",
    }),
    name: z.string().min(1).openapi({
      example: "Staff Diseminasi",
    }),
    employee_id: z.string().optional().openapi({
      example: "EMP001",
    }),
    grade_id: createCoercedIntSchema(7),
    position_id: createCoercedIntSchema(2),
    role_id: createCoercedIntSchema(2),
    signature_image: z.string().optional().openapi({
...
const updateUserRequestSchema = z
  .object({
    email: z.string().email().optional().openapi({
      example: "staff.updated@diseminasi.com",
    }),
    password: z.string().min(1).optional().openapi({
      example: "newpassword123",
    }),
    name: z.string().min(1).optional().openapi({
      example: "Staff Diseminasi Update",
    }),
    employee_id: z.string().optional().openapi({
      example: "EMP002",
    }),
    grade_id: createOptionalCoercedIntSchema(8),
    position_id: createOptionalCoercedIntSchema(3),
    role_id: createOptionalCoercedIntSchema(3),
    signature_image: z.string().optional().openapi({
      example: "https://res.cloudinary.com/example/signature-updated.png",
    }),
  })
